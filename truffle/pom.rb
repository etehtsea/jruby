  ...
  plugin( :compiler,
    ...
    execute_goals( 'compile',
                   ...
                   'annotationProcessors' => [ 'org.jruby.truffle.om.dsl.processor.OMProcessor',
                                               ...
                                               'com.oracle.truffle.dsl.processor.InstrumentationRegistrationProcessor',
                                               'com.oracle.truffle.dsl.processor.GenerateWrapperNodeProcessor'],
